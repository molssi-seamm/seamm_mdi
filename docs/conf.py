...
version = seamm_mdi.__version__
# The full version, including alpha/beta/rc tags
release = seamm_mdi.__version__
...
# html_theme_options = {}
html_theme_options = {
    "github_url": "https://github.com/molssi-seamm/seamm_mdi",
...
htmlhelp_basename = 'seamm_mdidoc'
...
latex_documents = [
    (master_doc, 'seamm_mdi.tex', 'SEAMM-MDI Documentation',
     'seamm_mdi', 'manual'),
]
...
man_pages = [
    (master_doc, 'seamm_mdi', 'SEAMM-MDI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'seamm_mdi', 'SEAMM-MDI Documentation',
     author, 'seamm_mdi', 'Connector between SEAMM and ASE',
     'Miscellaneous'),
]
